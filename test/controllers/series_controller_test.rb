...
class SeriesControllerTest < ActionController::TestCase
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post :create, series: { banner_image: @series.banner_image, description: @series.description, post_ids: @series.post_ids, title: @series.title }
    end
  ...
  test "should update series" do
    patch :update, id: @series, series: { banner_image: @series.banner_image, description: @series.description, post_ids: @series.post_ids, title: @series.title }
    assert_redirected_to series_path(assigns(:series))
  end
